...
def generate_trait_set_from_config():
    ...
    for layer in CONFIG:
        # print("before", layer["traits"])
        # glass = [i for i in layer["traits"] if "sunglasses" in i]
        # if glass:
        #     print(layer["traits"])
        #     bandana = [i for i in layer["traits"] if "bandana" in i]
        #     layer["traits"] = [i for i in layer["traits"] if i not in bandana]
        # print("after", layer["traits"])
